...
public class MemberArrayTaining{
...
//같은 패키지라고 해도 같은 폴더내에 없으면 사용이 불가하다!!!
	...
	//1. 변수의 자료형 선언
	 ...
	 private double weight;
		...
		public MemberArrayTaining(String name, String dateOfBirth)
		{
		...
		public MemberArrayTaining(String name, String dateOfBirth, double height, double weight, String bloodType)
		{
			 this.name = name;
			 this.dateOfBirth=dateOfBirth;
		...
		public int getAge(){
			...
			int year = Integer.parseInt(dateOfBirth.substring(0,2));//문자열로 받았기에 년도파트를 숫자로 바꿈.
			//Integer.parseInt 꼭 외워기억해주세요!!ㅠㅠ
			int age = cal.get(Calendar.YEAR) - 1900 -year;
	//		if(age > 100) age-1=100;
			return age;
		}
