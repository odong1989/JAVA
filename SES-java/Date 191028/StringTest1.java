...
//		System.out.println( b.length() );	
		...
		a="abcABCabcABC";
		System.out.println("a=\"abcABCabcABC\";");	
		System.out.println("a.charAt(1)         : " + a.charAt(1) );	
		System.out.println("a.indexOf('c')      : " + a.indexOf('c') );//[결과]2를 리턴한다. c의 좌표는 0부터 시작해서 2이다.	
		System.out.println("a.indexOf('d')      : " + a.indexOf('d') );//[결과]-1를 리턴한다. 못 찾았을 경우 -1을 리턴합니다.
		System.out.println("a.indexOf('c',3)    : " + a.indexOf('c',3) );//c를 검색한다. 단, 3번째 칸부터 시작한다.
		System.out.println("a.indexOf(\"cccc\") : " + a.indexOf("cccc") );
...
//		System.out.println( a.substring('6') );
		...
		System.out.println("a.lastIndexOf(\"abc\") : "+ a.lastIndexOf("abc") );
		System.out.println("a.valueOf(\"AB\")      : "+ a.valueOf("AB") );
		System.out.println("a. endsWith(\"c\")    : "+ a. endsWith("c") ); //"c"로 끝나는가?
		System.out.println("a. toUpperCase()     : "+ a. toUpperCase());	//문자열 내의 "b"를 모두 "B"로 변경하세요.
		System.out.println("");
