...
[조건2] 아래의 기능들을 구현해주십시오.							|[조건2] 아래의 기능들을 구현해주십시오.	
...
[조건2.4] int형 정수 하나를 전달받아 모든 원소에 더하기 하는 메소드		|[조건2.4] public void sumAll(int value) 메소드로 구현.
[조건2.5] 정수 2개를 전달받아 a의 b승을 구하여 리턴하는 메소드			|[조건2.5] public int power(int Base, int Indices) 메소드로 구현.
========================================================================================
*/
...
{//public = "소환술처럼 어디서 부르시든 저를 쓰실수 있습니다"
	...
	public int power(int Base, int Indices)//선생님은 square으로 명을 설정함.
	{ //Base : 밑수
	  //Indices : 지수
	    int resultPower=1;
