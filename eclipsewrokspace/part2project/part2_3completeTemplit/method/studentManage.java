...
class studentManage{
	//목표 : 기존의 배열로 구성했던 학생정보를 ArrayList으로 바꿔봅시다.
...
//		sortBubble();
		...
		for (int view=0; view < studentArray.size ; view++)
		{
